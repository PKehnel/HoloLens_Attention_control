...
public class BoxManagerVisual : BoxManagerAbstract
{

    public ObjectIndicatorVisual Indicator;
    ...
    private void WriteToHoloLens() //Write score to a file
    {
            ...
            StorageFile textFileForWriteAndRead = await storageFolder.CreateFileAsync("BoxManagerVisual.txt",
