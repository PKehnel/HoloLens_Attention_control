...
public class BoxManagerVisualAndAudio: BoxManagerAbstract
{

    public ObjectIndicatorVisualAndAudio Indicator;
	...
	void Update () { //If time is over write to file and go to next level
    ...
    private void WriteToHoloLens() //Write score to a file
    {
            ...
            StorageFile textFileForWriteAndRead = await storageFolder.CreateFileAsync("BoxManagerVisualAndAudio.txt",
