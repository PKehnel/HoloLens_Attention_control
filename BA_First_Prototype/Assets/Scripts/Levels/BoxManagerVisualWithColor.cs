...
public class BoxManagerVisualWithColor : BoxManagerAbstract
{

    public ObjectIndicatorVisualWithColor Indicator;
    ...
    private void WriteToHoloLens() //Write score to a file
    {
            ...
            StorageFile textFileForWriteAndRead = await storageFolder.CreateFileAsync("BoxManagerVisualWithColor.txt",
