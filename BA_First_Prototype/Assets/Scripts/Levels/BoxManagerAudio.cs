...
public class BoxManagerAudio : BoxManagerAbstract
{

    public ObjectIndicatorAudio Indicator;
    ...
    private void WriteToHoloLens() //Write score to a file
    {
            ...
            StorageFile textFileForWriteAndRead = await storageFolder.CreateFileAsync("BoxManagerAudio.txt",
